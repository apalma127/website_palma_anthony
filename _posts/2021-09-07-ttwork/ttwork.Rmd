...
nurses_new %>%
    ...
    labs(x = "Total Number of RN", 
         y = "Income Inequality Percent", 
        title = "Which State's Have a Greter Discrepancy In Pay for RN's?") +
    theme_classic() +
    theme(
...
NOTE: Higher Inc Ineq percent reveals a state with a significantly higher average salary than median salary, showing a higher discrepancy in pay with more nurses paid significantly more than the bulk.  A negative percent reveals a discrepancy where more nurses are significantly underpaid relative to the median salary than overpaid.  


**I wanted to look at how different states pay to nurses compares to their median pay.  As you can see, most have + income inequality variables meaning they have higher avg annual salaries than median annual salaries by a certain percent.  Because of the nature of how average is calculated compared to median, having a higher avg salary is a result of having much higher top salaries.  For the few with negative scores like Hawaii, this reflects a pool of nurses that have more signifcantly underpaid relative to the median than signifcantly overpaid.  While it may be a bit difficult to understand at first glance, having your avergae annual salary up to 5% higher than your average median salary is very interesting to see....One point to not is that as the number of nurses increase, the perceived income inequality goes down closer to 0.**
