...
```{r, cache=TRUE}
    ...
    geom_text(aes(label= season), color = "navy", hjust=0, vjust=0, size=4, check_overlap = TRUE) +
    ...
    labs(x = "Season Number", 
        ...
        title = "Survivor Premier Viewership, with Reference to Average and Median Premier") +
    theme_classic() +
    theme(
